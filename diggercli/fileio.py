...
def download_terraform_files(projectName, environment, target, services, destinationDir):
    response = api.download_terraform_async(projectName, environment, target, services)
